...
INSERT INTO contacts (id, version, is_archival, created_by, created_at, first_name, last_name, address_id)
    VALUES (nextval('contacts_seq'), 0, false, 'jan123', now(), 'Jan', 'Kowalski', (SELECT id FROM addresses WHERE postal_code = '111-111'));
...
INSERT INTO contacts (id, version, is_archival, created_by, created_at, first_name, last_name, address_id)
    VALUES (nextval('contacts_seq'), 0, false, 'michal123', now(), 'Michał', 'Nowak', (SELECT id FROM addresses WHERE postal_code = '222-222'));
INSERT INTO accounts (id, version, is_archival, created_by, created_at, login, email, password, locale, contact_id, state, roles, unsuccessful_auth_counter)
...
INSERT INTO contacts (id, version, is_archival, created_by, created_at, first_name, last_name, address_id)
    VALUES (nextval('contacts_seq'), 0, false, 'john123', now(), 'John', 'Doe', (SELECT id FROM addresses WHERE postal_code = '333-333'));
INSERT INTO accounts (id, version, is_archival, created_by, created_at, login, email, password, locale, contact_id, state, roles, unsuccessful_auth_counter)
