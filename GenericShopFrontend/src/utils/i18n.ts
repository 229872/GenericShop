...
const resources = {
  en: {
    translation: {
      ...
      'create_account.step.1.error.account_state': 'Account state must be ACTIVE, BLOCKED or NOT_ACTIVE',
      'create_account.step.1.error.account_role': 'Account role must be GUEST, CLIENT, ADMIN or EMPLOYEE',
  ...
  pl: {
    translation: {
      ...
      'create_account.step.1.error.account_state': 'Stan konta musi być ACTIVE, BLOCKED albo NOT_ACTIVE',
      'create_account.step.1.error.account_role': 'Rola konta musi być GUEST, CLIENT, ADMIN albo EMPLOYEE',
      'create_account.step.1.label.login': 'Login',
      'create_account.step.1.label.email': 'Email',
