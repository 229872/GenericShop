...
@Slf4j
public class OrdersModuleTxLogsListener implements TransactionExecutionListener {
    ...
    public void afterBegin(@NonNull TransactionExecution transaction, Throwable beginFailure) {
        ...
        log.info("TX id={}: OrdersModule transaction STARTED with identity: {} in {}", transactionId,
    ...
    public void afterCommit(@NonNull TransactionExecution transaction, Throwable commitFailure) {
        ...
        log.info("TX id={}: OrdersModule transaction ENDS with status COMMIT, identity: {} in {}", transactionId,
            SecurityUtil.getLoginFromSecurityContext(), transaction.getTransactionName());
    ...
    public void afterRollback(@NonNull TransactionExecution transaction, Throwable rollbackFailure) {
        ...
        log.info("TX id={}: OrdersModule transaction ENDS with status ROLLBACK, identity: {} in {}", transactionId,
            SecurityUtil.getLoginFromSecurityContext(), transaction.getTransactionName());
